...
├── bin/                ← ponto de entrada do CLI (agentforge.js)
├── lib/
...
1. Crie a pasta `agents/agentforge-[nome]/`
...
MIT. Veja [LICENSE](https://github.com/bcocheto/agentforge/blob/main/LICENSE) para os detalhes.

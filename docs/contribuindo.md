...
├── bin/                ← CLI entry point (agentforge.js)
├── lib/
...
1. Create the folder `agents/agentforge-[name]/`
...
MIT. See [LICENSE](https://github.com/bcocheto/agentforge/blob/main/LICENSE) for details.

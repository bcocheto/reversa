...
export const DEFAULT_GENERATED_SUBAGENT_IDS = Object.freeze([
  "database-specialist",
  "security-reviewer",
...
/**
 * Keeps legacy agentforge installations readable while the product migrates.
...
export function resolveInternalDir(projectRoot) {
  for (const internalDir of INTERNAL_DIRS) {
    if (existsSync(join(projectRoot, internalDir, "state.json")))
      return internalDir;
  }

...
export async function runInstallPrompts(detectedEngines) {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      message: 'Internal agents to install:',
      choices: [
    ...
    },
    {
      ...
      type: 'list',
      name: 'response_mode',
      message: 'How should the team collect follow-up answers?',
      loop: false,
      choices: [
  ...
  const internalAgents = [...requiredAgentValues, ...answers.optional_agents];
  return {
    ...answers,

...
import { getManifestPath } from '../product.js';
...
export function mergeUpdateManifest(existingManifest, intactPaths, modifiedPaths, newManifest) {
  const preservedEntries = {};
  for (const relPath of new Set([...intactPaths, ...modifiedPaths])) {
    if (Object.prototype.hasOwnProperty.call(existingManifest, relPath)) {
      preservedEntries[relPath] = existingManifest[relPath];
    }
  }

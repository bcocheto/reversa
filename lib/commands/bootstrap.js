...
function renderContextIndex(context) {
  ...
  const doc = {
    ...
    flows: [
      ...
      { id: 'context-curation', path: 'flows/context-curation.md', purpose: 'Organize, review, and index durable project context.' },
      { id: 'release', path: 'flows/release.md', purpose: 'Promote a safe release-ready delivery.' },
    ],
    task_contexts: {
      feature: {
        context: [

...
function renderHelp(chalk) {
  ...
  console.log('  Gera `.agentforge/reports/skill-suggestions.md` e arquivos YAML em `.agentforge/suggestions/skills/`.');
  console.log('  Continua lendo `.agentforge/skill-suggestions/` como legado compatível.\n');
}

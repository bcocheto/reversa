...
export const COMMAND_REGISTRY = Object.freeze([
  ...
  },
  {
    id: 'adopt',
    category: 'adoption',
    usage: 'adopt [--prepare] | adopt --apply --from-ai <path>',
    description: 'Coleta evidências e, quando recebe um blueprint validado, materializa a adoção.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/adoption-plan.md', '.agentforge/reports/adoption-apply.md', '.agentforge/reports/agentic-blueprint-validation.md', '.agentforge/state.json'],
    examples: ['adopt', 'adopt --prepare', 'adopt --apply --from-ai .agentforge/ai/outbox/agentic-blueprint.yaml'],
    status: 'stable',
    module: './adopt.js',
  },
  {
  ...
  },
  {
    id: 'suggest-agents',
    category: 'agents',
    usage: 'suggest-agents [--heuristic] [--force]',
    description: 'Gera um request formal para a IA ativa sugerir agentes e mantém o fluxo heurístico atrás de `--heuristic`.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/ai/requests/**', '.agentforge/ai/evidence/**', '.agentforge/suggestions/agents/**', '.agentforge/reports/agent-suggestions.md', '.agentforge/state.json'],
    examples: ['suggest-agents', 'suggest-agents --heuristic', 'suggest-agents --force'],
    status: 'stable',
  ...
  },
  {
    ...
    category: 'meta',
    usage: 'apply-suggestions [--agents] [--skills] [--flows] [--all] [--dry-run] [--force] [--blueprint <path>]',
    description: 'Aplica sugestões de agentes, skills, flows e policies ou materializa um blueprint completo da IA.',
    aliases: [],
    safeByDefault: false,
    ...
    examples: ['apply-suggestions', 'apply-suggestions --dry-run', 'apply-suggestions --all', 'apply-suggestions --agents --skills', 'apply-suggestions --blueprint .agentforge/ai/outbox/agentic-blueprint.yaml'],
    status: 'stable',
  ...
  },
  {
    id: 'context-map',
    category: 'context',
    usage: 'context-map [--json] [--write] [--check]',
    description: 'Gera e valida o mapa granular de contexto com arquivos e ranges de linha.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/harness/context-map.yaml', '.agentforge/reports/context-map.md'],
    examples: ['context-map', 'context-map --write', 'context-map --check', 'context-map --json'],
    status: 'stable',
    module: './context-map.js',
  },
  {
    id: 'audit-context',
    category: 'inspection',
  ...
  },
  {
    id: 'refactor-context',
    category: 'context',
    usage: 'refactor-context [--apply] [--force] [--curation-input]',
    description: 'Prepara insumos de contexto para curadoria semântica da IA ativa.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/refactor-plan.md', '.agentforge/context/**'],
    examples: ['refactor-context', 'refactor-context --apply', 'refactor-context --apply --force', 'refactor-context --curation-input'],
    status: 'stable',
  ...
  },
  {
    id: 'context-pack',
    category: 'context',
    usage: 'context-pack <task-mode> [--json] [--write] | context-pack --task <description> [--json] [--write]',
    description: 'Monta um pacote de contexto ordenado a partir do contexto index e dos modos de tarefa.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/context-pack-*.md', '.agentforge/state.json'],
    examples: [
      'context-pack feature',
      'context-pack bugfix --write',
      'context-pack review --json',
      'context-pack documentation',
      'context-pack context-curation --write',
      'context-pack --task "descrição da tarefa"',
    ],
    status: 'stable',
    module: './context-pack.js',
  },
  {
    id: 'import-ai-suggestions',
    category: 'ai',
    usage: 'import-ai-suggestions --kind <agents|skills|flows|policies|context> --file <path> [--force]',
    description: 'Importa sugestões produzidas pela IA ativa e as grava como sugestões canônicas revisáveis.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/suggestions/agents/**', '.agentforge/suggestions/skills/**', '.agentforge/suggestions/flows/**', '.agentforge/suggestions/policies/**', '.agentforge/suggestions/context/**', '.agentforge/reports/import-ai-suggestions.md', '.agentforge/state.json'],
    examples: [
      'import-ai-suggestions --kind agents --file .agentforge/ai/outbox/agents.yaml',
      'import-ai-suggestions --kind skills --file .agentforge/ai/outbox/skills.yaml',
      'import-ai-suggestions --kind flows --file .agentforge/ai/outbox/flows.yaml',
      'import-ai-suggestions --kind policies --file .agentforge/ai/outbox/policies.yaml',
      'import-ai-suggestions --kind context --file .agentforge/ai/outbox/context.yaml',
    ],
    status: 'stable',
    module: './import-ai-suggestions.js',
  },
  {
    id: 'ai-evidence',
    category: 'ai',
    usage: 'ai-evidence [--json] [--force]',
    description: 'Gera um pacote de evidências para a IA ativa sem produzir sugestões heurísticas.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/ai/evidence/**', '.agentforge/reports/ai-evidence.md', '.agentforge/state.json'],
    examples: ['ai-evidence', 'ai-evidence --json', 'ai-evidence --force'],
    status: 'stable',
    module: './ai-evidence.js',
  },
  {
    id: 'suggest-skills',
    category: 'skills',
    usage: 'suggest-skills [--heuristic] [--force]',
    description: 'Gera um request formal para a IA ativa sugerir skills e mantém o fluxo heurístico atrás de `--heuristic`.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/ai/requests/**', '.agentforge/ai/evidence/**', '.agentforge/suggestions/skills/**', '.agentforge/skill-suggestions/**', '.agentforge/reports/skill-suggestions.md', '.agentforge/state.json'],
    examples: ['suggest-skills', 'suggest-skills --heuristic', 'suggest-skills --force'],
    status: 'stable',
  ...
  },
  {
    id: 'handoff',
    category: 'inspection',
    usage: 'handoff [--engine <name>] [--phase <phase-id>] [--json]',
    description: 'Gera a orientação para a IA ativa executar a próxima fase com julgamento contextual.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/handoff.md'],
    examples: ['handoff', 'handoff --engine codex', 'handoff --json'],
    status: 'stable',
    module: './handoff.js',
  },
  {
    id: 'codex-plan',
    category: 'inspection',
    usage: 'codex-plan [--engine <name>] [--phase <phase-id>] [--json]',
    description: 'Deprecated alias temporário para handoff.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/handoff.md'],
    examples: ['codex-plan', 'codex-plan --engine codex'],
    status: 'deprecated',
    module: './codex-plan.js',
  },
  {
    id: 'checkpoint',
    category: 'inspection',
    usage: 'checkpoint <phase-id> --status <done|blocked|skipped> [--reason <text>] [--dry-run]',
    description: 'Registra o checkpoint explícito de uma fase no workflow estruturado.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/state.json', '.agentforge/plan.md', '.agentforge/workflow/history.jsonl', '.agentforge/reports/checkpoint.md', '.agentforge/config/manifest.yaml'],
    examples: ['checkpoint discovery --status done', 'checkpoint discovery --status blocked --reason "missing context"', 'checkpoint discovery --status skipped --reason "not applicable"'],
    status: 'stable',
    module: './checkpoint.js',
  },
  {
    id: 'phases',
    category: 'inspection',
  ...
  },
  {
    ...
    description: 'Mostra a próxima fase e gera orientação; não executa trabalho inteligente.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/advance.md'],
...
export const COMMAND_STATUS_VALUES = Object.freeze(['stable', 'experimental', 'planned', 'deprecated']);

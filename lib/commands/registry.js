...
export const COMMAND_REGISTRY = Object.freeze([
  ...
  {
    id: 'refactor-agentic-surface',
    category: 'adoption',
    usage: 'refactor-agentic-surface [--plan] [--apply] [--force]',
    description: 'Refatora a superfície agentic legada para a estrutura canônica da AgentForge.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/reports/agentic-surface-refactor-plan.md', '.agentforge/reports/agentic-surface-refactor.md', '.agentforge/suggestions/**', '.agentforge/skills/**', '.agentforge/context/**', '.agentforge/references/**', '.agentforge/policies/**', '.agentforge/flows/**', '.agentforge/harness/context-index.yaml', '.agentforge/harness/context-map.yaml', '.agentforge/imports/snapshots/**', '.agentforge/state.json'],
    examples: ['refactor-agentic-surface', 'refactor-agentic-surface --plan', 'refactor-agentic-surface --apply', 'refactor-agentic-surface --apply --force'],
    status: 'stable',
    module: './refactor-agentic-surface.js',
  },
  {
    id: 'analyze',
    category: 'inspection',

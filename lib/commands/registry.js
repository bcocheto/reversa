...
export const COMMAND_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    category: 'inspection',
    usage: 'analyze',
    description: 'Analisa o projeto antes de criar ou modificar agentes, skills, flows, policies e contexto.',
    aliases: [],
    safeByDefault: true,
    writes: ['.agentforge/suggestions/**', '.agentforge/reports/project-analysis.md', '.agentforge/reports/analysis-plan.md', '.agentforge/state.json'],
    examples: ['analyze'],
    status: 'stable',
    module: './analyze.js',
  },
  ...
  },
  {
    id: 'compile',
    category: 'publishing',
    usage: 'compile [--force] [--takeover-entrypoints]',
  ...
  },
  {
    ...
    category: 'inspection',
    usage: 'next',
    description: 'Mostra a próxima fase recomendada a partir de state.json e plan.md.',
    aliases: [],
    safeByDefault: true,
    writes: [],
    examples: ['next'],

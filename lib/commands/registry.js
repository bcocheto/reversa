...
export const COMMAND_REGISTRY = Object.freeze([
  ...
  },
  {
    id: 'adopt',
    category: 'adoption',
    usage: 'adopt [--prepare] [--apply] [--from-ai <path>]',
    description: 'Coleta evidências, prepara a IA ativa e, opcionalmente, aplica a adoção.',
    aliases: [],
    safeByDefault: true,
    ...
    examples: ['adopt', 'adopt --prepare', 'adopt --apply', 'adopt --apply --from-ai .agentforge/ai/outbox/agentic-blueprint.yaml'],
    status: 'stable',
    module: './adopt.js',
  },
  {

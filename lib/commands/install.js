...
`));
  ...
  try {
    ...
    if (existing.installed) {
      ...
      if (existsSync(statePath)) {
        ...
        s.internal_agents = answers.internal_agents ?? answers.agents;
  ...
  console.log(`  ${chalk.cyan('Internal agents:')} ${answers.internal_agents?.length ?? answers.agents.length} installed`);

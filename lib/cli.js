...
const COMMAND_LOADERS = {
  ...
  'export-package':  () => import('./commands/export-package.js'),
...
function renderHelp(binaryName) {
  ...
  Comandos:
    install            Instala o AgentForge e prepara a camada agent-ready inicial
    ...
    compile            Atualiza os bootloaders reais do projeto e os entrypoints das engines
    ...
    export             Alias de compile
                       Opções: --package  Gera o pacote isolado em _agentforge/
    export-package     Gera o pacote isolado em _agentforge/ sem alterar os entrypoints reais
                       Opções: --force  Regenera o pacote com sobrescrita explícita

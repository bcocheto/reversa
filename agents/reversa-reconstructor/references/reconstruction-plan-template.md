...
**Status:** pending
**Lê:** `_agentforge/erd-complete.md`, `_agentforge/data-dictionary.md`
...
**Status:** pending
**Lê:** `_agentforge/domain.md`, `_agentforge/data-dictionary.md`
...
**Status:** pending
**Lê:** `_agentforge/state-machines.md`
...
**Obs:** Pular esta tarefa se `_agentforge/state-machines.md` não existir
...
**Status:** pending
**Lê:** `_agentforge/sdd/[componente].md`, `_agentforge/dependencies.md`
...
**Status:** pending
**Lê:** `_agentforge/openapi/[lista de arquivos]`
...
**Status:** pending
**Lê:** `_agentforge/user-stories/[lista de arquivos]`

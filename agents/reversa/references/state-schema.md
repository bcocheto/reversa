# Schema — .agentforge/state.json

Este arquivo persiste o estado completo da análise entre sessões. O AgentForge lê e escreve neste arquivo.
...
```json
{
  ...
  "checkpoints": {
    ...
    "archaeologist": {
      ...
      "files": [
        "_agentforge/code-analysis.md",
        "_agentforge/data-dictionary.md",
        ".agentforge/context/modules.json"
      ]
    }
  },
  "created_files": [
    "CLAUDE.md",
    ".agents/skills/agentforge/SKILL.md",
...
|-------|------|-----------|
| `version` | string | Versão do AgentForge instalada |
...
| `output_folder` | string | Pasta de saída das specs (padrão: `_agentforge`) |
...
| `created_files` | string[] | Todos os arquivos criados pelo AgentForge (para uninstall seguro) |
